...
export default function ResourcesPage() {
  return <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
    ...
    <section className="mt-10" aria-labelledby="practical-guides">
      ...
      <article className="mt-5 rounded-2xl border border-slate-200 p-6">
        <h3 className="text-xl font-semibold"><Link href="/metabolism/free-recipes-vs-paid-meal-plans/" className="text-blue-800 underline underline-offset-4">Free recipes vs paid meal plans: what is worth paying for?</Link></h3>
        <p className="mt-3 max-w-3xl leading-relaxed text-slate-700">Try a free planning exercise, compare the organizing work each resource does and check the full cost and renewal terms before buying.</p>
      </article>
      <article className="mt-5 rounded-2xl border border-slate-200 p-6">
      ...
      <article className="mt-5 rounded-2xl border border-slate-200 p-6">
        <h3 className="text-xl font-semibold"><Link href="/metabolism/free-workout-videos-vs-paid-programs/" className="text-blue-800 underline underline-offset-4">Free workout videos vs paid programs: is structure worth it?</Link></h3>
        <p className="mt-3 max-w-3xl leading-relaxed text-slate-700">Compare individual videos, free scheduled plans and paid programs. Identify the organizing features you would actually use before paying.</p>
      </article>
    </section>
