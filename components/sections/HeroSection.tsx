      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            >
              <div>
                <div className="text-2xl font-bold text-slate-900">{articleCount}</div>
                <div className="text-xs text-slate-500 font-medium uppercase tracking-wide mt-1">Published Articles</div>
              </div>
              <div className="w-px h-10 bg-slate-100 hidden sm:block" />
              <div>
                <div className="text-2xl font-bold text-slate-900">Open</div>
                <div className="text-xs text-slate-500 font-medium uppercase tracking-wide mt-1">Source Links</div>
              </div>
              <div className="w-px h-10 bg-slate-100 hidden sm:block" />
              <div>
                   ...
                   <div className="bg-white rounded-xl shadow-lg border border-slate-100 p-6 max-w-sm mx-auto transform rotate-[-2deg] hover:rotate-0 transition-transform duration-500">
                    ...
                    <div className="absolute bottom-12 right-12 bg-white rounded-lg shadow-lg border border-slate-100 p-4 transform translate-x-4">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-sm font-medium text-slate-700">Sources Included</span>
                        </div>
                    </div>
                </div>
             </div>
