...
featured: true
faqs:
  - question: "What is the most common side effect of GLP-1 medications?"
    answer: "Nausea is the most common side effect, affecting roughly 40–50% of users on semaglutide and 25–30% on tirzepatide. It is typically mild to moderate, dose-dependent, and improves after the first 4–8 weeks of treatment."
  - question: "How long do GLP-1 side effects last?"
    answer: "Most gastrointestinal side effects are worst during dose escalation and improve within 4–8 weeks of reaching a stable dose. Persistent or severe symptoms should be discussed with your prescriber — they may adjust the titration schedule or pause at a lower dose."
  - question: "Do GLP-1 medications cause thyroid cancer?"
    answer: "GLP-1 receptor agonists carry a boxed warning for medullary thyroid carcinoma based on rodent studies. Human data have not confirmed an increased risk. They are contraindicated in patients with a personal or family history of medullary thyroid carcinoma or Multiple Endocrine Neoplasia type 2 (MEN2)."
  - question: "Can GLP-1 medications cause pancreatitis?"
    answer: "Acute pancreatitis is a rare but documented adverse event with GLP-1 agonists. The absolute risk is low (estimated 0.1–0.2% per year), but anyone with a history of pancreatitis should use these drugs with caution and discuss alternatives with their clinician."
  - question: "How do I manage nausea on Ozempic or Wegovy?"
    answer: "Eat smaller and more frequent meals, avoid fatty or greasy foods, stay well hydrated, and avoid lying down immediately after eating. Slowing dose escalation (staying on a lower dose longer before increasing) is the most effective medical intervention if lifestyle steps are not enough."
  - question: "Is muscle loss a concern with GLP-1 drugs?"
    answer: "Any major weight loss intervention, including GLP-1 therapy and bariatric surgery, reduces lean mass alongside fat. Resistance exercise 2–3 times per week and adequate protein intake (1.2–1.6 g/kg/day) are the standard recommendations to preserve muscle during treatment."
---
...
[5] FDA. GLP-1 Receptor Agonists Drug Safety Communication. U.S. Food and Drug Administration. [FDA](https://www.fda.gov/drugs/postmarket-drug-safety-information-patients-and-providers)
