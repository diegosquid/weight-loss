...
Trulicity comes in single-dose pens. US Ozempic labeling includes both multidose pens and single-dose prefilled syringes, so preparation and storage instructions depend on the presentation dispensed. Check the device-specific instructions with the pharmacist. Sources: [Trulicity prescribing information](https://pi.lilly.com/us/trulicity-uspi.pdf) and [Ozempic prescribing information](https://www.novo-pi.com/ozempic.pdf).

### Refrigeration and Storage

The US [Trulicity label](https://pi.lilly.com/us/trulicity-uspi.pdf) permits a total of 14 days outside refrigeration at temperatures no higher than 30°C (86°F). That is not the Ozempic limit: the [Ozempic label](https://www.novo-pi.com/ozempic.pdf) specifies 56 days after first use for the multidose pen, either at 15–30°C (59–86°F) or refrigerated at 2–8°C (36–46°F). Unused Ozempic pens require refrigeration; its single-dose syringe has a separate 28-day allowance at 8–30°C (46–86°F). Do not freeze either medicine or use it after freezing. Review the [GLP-1 storage table by brand and device](/medications/glp1-storage-handling/) before applying a storage limit.
...
*Device and storage sections corrected September 17, 2026 using current US manufacturer labels. Other sections were not re-reviewed in this update.*
